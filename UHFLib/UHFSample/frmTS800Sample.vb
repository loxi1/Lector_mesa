...
Public Class frmTS800Sample
    ...
    Private Sub frmInitial_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        gbxOutputFormat.Visible = False         'Don't display this setting because TS800 does not support this function

        With cbxKeyboardSimulation.Items
            .Clear()
            .Add(New ComboBoxItem(True, OutputInterface.Default, "Default"))
            .Add(New ComboBoxItem(OutputInterface.TCP_Server, "TCP Server"))
        End With

        gbxFilter.Visible = False       'Don't display this setting because TS800 does not support this function        
        ...
        With cbxScanMode.Items
            .Clear()
            .Add(New ComboBoxItem(True, TS800.ScanMode.AlwaysScan, "Always Scan"))
            .Add(New ComboBoxItem(TS800.ScanMode.Trigger_A_LevelControl, "Trigger A Level Control"))
        End With
        ...
        gbxEventType.Visible = False        'Don't display this setting because TS800 does not support this function
        ...
        With cbxActiveMode.Items
            ...
            'TS800 does not support the following paramters to set
        ...
        gbxBuzzer.Visible = True
        With cbxBuzzerOperationMode.Items
            .Clear()
            .Add(New ComboBoxItem(BuzzerOperationMode.OFF, "Off"))
            '.Add(New ComboBoxItem(BuzzerOperationMode.ONCE, "Once"))       'TS800 does not support this paramter to set
        ...
        gbxInventoryEx.Visible = False          'Don't display this setting because TS800 does not support this function
    ...
    Private Sub cbLeftLight_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbLeftLight.CheckedChanged
        If cbLeftLight.Checked Then
            _ts800.SetIOState(IONumber.Output_Pin_0, IOState.High)
        Else
            _ts800.SetIOState(IONumber.Output_Pin_0, IOState.Low)
        End If
    End Sub
    ...
    Private Sub cbMidLight_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbMidLight.CheckedChanged
        If cbMidLight.Checked Then
            _ts800.SetIOState(IONumber.Output_Pin_1, IOState.High)
        Else
            _ts800.SetIOState(IONumber.Output_Pin_1, IOState.Low)
        End If
    End Sub
    ...
    Private Sub cbRightLight_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbRightLight.CheckedChanged
        If cbRightLight.Checked Then
            _ts800.SetIOState(IONumber.Output_Pin_2, IOState.High)
        Else
            _ts800.SetIOState(IONumber.Output_Pin_2, IOState.Low)
        End If
    End Sub
    ...
    Private Sub btnWriteEPC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnWriteEPC.Click
        ...
        writeDataByte = HexStringToByteArray(szData)
        bResult = _ts800.WriteEPC(szSelectedTagEPCHexString, szPassword, writeDataByte)
    ...
    Private Sub btnBuzzerControl_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuzzerControl.Click
        ...
        result = _ts800.ControlBuzzer(buzzerActionValue)
    ...
    Private Sub InitializeUI()
        ...
        lblBLEROMVersion.Text = _ts800.GetBleRomVersion
        tbBLEDeviceName.Text = _ts800.GetBleDeviceName
    ...
    Private Sub btnSetQValue_Click(sender As Object, e As EventArgs) Handles btnSetQValue.Click
        ...
        result = _ts800.SetQValue(False, qValue)
        If result Then
    ...
    Private Sub btnSetSessionTarget_Click(sender As Object, e As EventArgs) Handles btnSetSessionTarget.Click
        ...
        result = _ts800.SetSessionAndTarget(False, session, target)
        If result Then
    ...
    Private Sub btnSetOutputInterface_Click(sender As Object, e As EventArgs) Handles btnSetOutputInterface.Click
        Dim result As Boolean
        Dim outputInterface As OutputInterface
        ...
        outputInterface = ComboBoxItem.GetCurrentItemValue(cbxKeyboardSimulation)
        ...
        result = _ts800.SetOutputInterface(False, outputInterface)
        If result Then
    ...
    Private Sub btnGetOutputInterface_Click(sender As Object, e As EventArgs) Handles btnGetOutputInterface.Click
        Dim outputInterface As OutputInterface
        outputInterface = _ts800.GetOutputInterface(False)
        ComboBoxItem.SelectItemByValue(cbxKeyboardSimulation, outputInterface)
    End Sub
    ...
    Private Sub BtnSetPresentedThreshold_Click(sender As Object, e As EventArgs) Handles btnSetTagPresentRepeatInterval.Click
        ...
        result = _ts800.SetTagPresentedRepeatInterval(False, param)
        If result Then
    ...
    Private Sub BtnSetRemoveThreshold_Click(sender As Object, e As EventArgs) Handles btnSetRemoveThreshold.Click
        ...
        result = _ts800.SetTagRemovedThreshold(False, param)
        If result Then
    ...
    Private Sub btnSetInvnetoryRoundInterval_Click(sender As Object, e As EventArgs) Handles btnSetInvnetoryRoundInterval.Click
        ...
        result = _ts800.SetInventoryRoundInterval(False, param)
        If result Then
    ...
    Private Sub btnLockTag_Click(sender As Object, e As EventArgs) Handles btnLockTag.Click
        ...
        If password.Length > 0 Then
            result = _ts800.LockTag(password, lockInfos)
        Else
            result = _ts800.LockTag(lockInfos)
        End If
        If result Then
    ...
    Private Sub btnKillTag_Click(sender As Object, e As EventArgs) Handles btnKillTag.Click
        ...
        If accessPassword.Length > 0 Then
            result = _ts800.KillTag(accessPassword, killPassword)
        Else
            result = _ts800.KillTag(accessPassword)
        End If
        If result Then
    ...
    Private Sub btnSetActiveMode_Click(sender As Object, e As EventArgs) Handles btnSetActiveMode.Click
        ...
        result = _ts800.SetInventoryActiveMode(False, activeMode)
        If result Then
    ...
    Private Sub btnSetCommandTriggerState_Click(sender As Object, e As EventArgs) Handles btnSetCommandTriggerState.Click
        Dim result As Boolean
        Dim state As State
        state = ComboBoxItem.GetCurrentItemValue(cbxCommandTriggerState)
        result = _ts800.SetCommandTriggerState(state)
        If result Then
    ...
    Private Sub btnGetCommandTriggerState_Click(sender As Object, e As EventArgs) Handles btnGetCommandTriggerState.Click
        Dim state As State
        state = _ts800.GetCommandTriggerState()
    ...
    Private Sub btnSetBLEName_Click(sender As Object, e As EventArgs) Handles btnSetBLEName.Click
        ...
        result = _ts800.SetBleDeviceName(name)
        If result Then
